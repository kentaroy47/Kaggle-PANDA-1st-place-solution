...
pretrained_path = {
    "se_resnext50_32x4d": "../input/pytorch-se-resnext/se_resnext50_32x4d-a260b3a4.pth"
}
...
def test():
    ...
    in_ch = 3
    model = CustomSEResNeXt(in_ch=3, out_ch=1, pool_type="gem", pretrained=False)
    print(model)

    summary(model, (in_ch, 256, 256))
